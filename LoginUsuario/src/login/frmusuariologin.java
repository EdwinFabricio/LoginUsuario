...
public class frmusuariologin extends javax.swing.JFrame {
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        ...
        try {
            //creamos el modelo- para sacar los datos de la base de datos
            DefaultTableModel modelo;
            //Inicializamos la clase  en la que haremos la consulta
            fusuario func =new fusuario();
  ///ejecutamos la funcion login que mandara si hay resultados que coinciden con el usuarios y pasword
            //ingresados
            
            modelo=func.login(txtusuario.getText(),txtpassword.getText());
          
            
            //sacamos la datos de la consulta en una tabla
            tablalistado.setModel(modelo);
            //comparamos si hay registros que coinciden con el usuario y pasword proporcionado
            if (func.totalregistros >0) {
                this.dispose();
                //si es mayor a 0 entonces significa que los datos coinden con la base de dato
                //y se puede loguear el usuario
                JOptionPane.showMessageDialog(this, "Se logueo correctamente", null, WIDTH, null);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //si no manda registros entonces no coinciden con la base de datos
            // y no puede acceder al sistema
            else {
